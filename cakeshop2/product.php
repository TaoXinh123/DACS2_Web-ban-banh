    ...
    <body>
        ...
        <div class="row_bl">
            <div class="col-md-8">
                ...
                <form action="checkcomment.php?actioncomment&productID=<?= $product_id ?>">
                <div id="responseMessage"></div>
                <p><input type="hidden" value="<?php echo $product_id; ?>" name="product_id" id="idsp"></p>
                <p><input type="text" placeholder="Điền tên" class="form-control" name="ten" id="ten"></p>
                <p><textarea rows="5" style="resize: none;" placeholder="Bình luận....." class="form-control" name="nhanxet" id="nhanxet"></textarea></p>
                <p><input type="submit" id="myButton" name="binhluan_submit" class="btn btn-success" value="Gửi bình luận"></p>
            </form>

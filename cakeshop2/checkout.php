<?php 
    ...
    //DATABASE CONNECTION  Boulangerie
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($city == "dn" || $city == "hcm" || $city == "ha" || $city == "qb" || $city == "hue" || $city == "hn" || $city == "qt") {
          //valid
        }
        else{
        ...
        //   $zipErr = "Invalid zip code TOI DA 6 SO";
        // }
        ...
        if (!preg_match("/^['0-9']{12}$/",$ccnum)) {
          $ccnumErr = "Invalid card number
          <br>
          We are sorry! Our system currently supports VISA cards only.Maximum 12";
        }
        ...
        if (empty($_POST["ccexp_m"]) || empty($_POST["ccexp_y"])) {
          ...
          if (!preg_match("/^['0-9']{4}$/",$cccvv)) {
            $cccvvErr = "Invalid CVV max 4"; //toi da 4 so
          }
...
<html lang="en">
  <head>
    ...
    <title>Boulangerie | Checkout</title>
  ...
  <div class="container">
    ...
    <main>
      ...
      <div class="py-5 text-center">
        <h1 class="business-name">Boulangerie</h1>
        <h2>Checkout Page</h2>
      </div>
        ...
        <div class="col-md-5 col-lg-4 order-md-last">
          ...
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between total-row">
              ...
              <strong class="price-tag">&dollar; <?php echo number_format($_SESSION['total_price'], 2); ?></strong>
            </li>
          </ul>
    ...
    <footer class="my-5 pt-5 text-muted text-center ">
      <p class="mb-1">&#169; <?php echo date("Y"); ?> All rights reserved. Made with &#x1F49C; by <b> Dream Markers </b> Team.</p>

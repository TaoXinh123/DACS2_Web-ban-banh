...
<html lang="en-MU">
    ...
    <body>
        ...
        <div class="slideshow-container"> 
            ...
            <img src="Assets/images/1.index/bg_2.jpg" style="width:100%">
            ...
            <div class="mySlides fade">
            <img src="Assets/images/1.index/bg_3.jpg" style="width:100%">
            <div class="text">A LITTLE BLISS IN EVERY BITE</div>
            </div>

            <div class="mySlides fade">
            <img src="Assets/images/1.index/bg_4.jpg" style="width:100%">
            <div class="text">A LITTLE BLISS IN EVERY BITE</div>
            </div>

            <div class="mySlides fade">
            <img src="Assets/images/1.index/bg_1.jpg" style="width:100%">
            <div class="text">A LITTLE BLISS IN EVERY BITE</div>
            </div>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper0">
                        ...
                        <div class = "helper-more-about">
                            ...
                            <p class="hierarchy">CEO - Boulangerie Bakery</p>
                            <p class="description">I appreciate your interest in Boulangerie Bakery and I encourage you to check the website to learn more about Boulangerie's history, growth, and range of products.
<br>
<br>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper2">
                        ...
                        <div class = "helper-more-about">
                            ...
                            <p class="description">We are focused on providing top of the line, gourmet quality baked goods that won’t break the bank. At 
                                 bakery we strive to create real guilt-free and delicious desserts that will put a smile on your face and leave you wanting more. &#127856;</p>
                        </div>

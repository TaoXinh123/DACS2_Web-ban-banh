<?php 
    ...
    $Q_insert_into_transaction = "INSERT INTO transaction (userID, name, orderID, paymentMethod, status)
    VALUES ('" . $_SESSION['userID'] . "', '" . $_POST['fname'] . "', '" . $_SESSION['orderID'] . "', '" . $_POST['paymentMethod'] . "', '1')";
...
<html lang="en">
    ...
    <body >
        ...
        <div class="py-5 text-center">
            <h1 class="business-name">La Boulangerie</h1>
            ...
            <a href="lichsu.php" class=" btn btn-primary btn-lg button" style="font-size:1.5vw;">Order history</a>
        </div>

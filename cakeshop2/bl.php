        ...
        <div class="container mx-auto mt-0 pt-0 ">
            <!-- <form method="POST" action="index.php?action=add&id=<?php //echo $product_id; ?>"> -->
                ...
                <div class="row">
                    ...
                    <!-- Danh gia binh luan  -->
                    <button style="width:30%" class="btn btn-primary btn-lg my-4 button"><a href="comment.php?productID=<?php echo $product_id ; ?> ">Comments</a></button>
                    <!-- <input type="submit" style="width:30%" name="binhluan" id="" value="Comment" class=" btn btn-primary btn-lg my-4 button"> -->
                    <!-- ============= -->
                </div>
